...
<!DOCTYPE html>
  ...
  <?php  if ($session->isUserLoggedIn(true)): ?>
    <header id="header">
      <div class="logo pull-left"> Asset System</div>
      <div class="header-content">
      <div class="header-date pull-left">
      <strong style="color: black;">Hi ! Your username: <?php echo remove_junk(ucfirst($user['username'])); ?> ; </strong>
...
setInterval(updateLiveTime, 1000); // Updated interval to 1000 milliseconds for seconds
