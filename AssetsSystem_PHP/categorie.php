      ...
      <div class="panel panel-default">
        <div class="panel-heading">
          <strong>
            ...
            <span>Add New Assets Type</span>
         </strong>
        </div>
        <div class="panel-body">
          <form method="post" action="categorie.php">
            <div class="form-group">
                <input type="text" class="form-control" name="categorie-name" placeholder="Assets Name">
            </div>
            <button type="submit" name="add_cat" class="btn btn-primary">Add Type</button>
        </form>
        </div>
      </div>
    </div>
