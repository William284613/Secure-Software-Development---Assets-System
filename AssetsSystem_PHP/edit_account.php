...
try {
    ...
    $session->msg('d', $e->getMessage()." ; Error update user profile pic ");
    redirect('edit_account.php');
}
...
try {
    if (isset($_POST['update'])) {
        ...
        if (empty($errors)) {
            ...
            if ($result && $db->affected_rows() === 1) {
                ...
                throw new Exception('No Data Changes, Failed to update account!');
            }
        } else {
    ...
    $session->msg('d', $e->getMessage()." ; Error update user info");
    redirect('edit_account.php');
}
?>
